...
describe('GrokCredentialTester', () => {
  it('reads weekly and monthly billing and verifies a real Responses request', async () => {
    const request = vi.fn<typeof fetch>()
      ...
      .mockResolvedValueOnce(response(200, { config: { monthlyLimit: 15000, used: 3000, billingPeriodEnd: '2026-08-01T00:00:00Z' } }))
    ...
    const headers = request.mock.calls[2][1]?.headers as Record<string, string>
