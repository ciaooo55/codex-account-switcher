...
- Codex 账号库、CPA Codex、CPA Grok 和定时切换候选列表均支持按剩余额度、账号等级、状态或邮箱排序；“有额度优先”会把可用账号聚合并按剩余比例排列。
...
- `Codex-Account-Switcher-Setup-0.9.0.exe`：安装版
- `Codex-Account-Switcher-Portable-0.9.0.exe`：便携版
